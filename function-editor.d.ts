...
export default class FunctionEditor9030 extends LitElement {
    ...
    addSubFunctionDialog: Dialog;
    subFunctionNameField: TextField;
    subFunctionDescField: TextField;
    subFunctionTypeField: TextField;
    subFunctionDialogParent?: Element;
    private openAddSubFunctionDialog;
    private onClosing;
    private isSubFunctionNameUnique;
    private getSubFunctionTagName;
    private createSubFunctionElement;
    private saveSubFunction;
    private renderAddSubFunctionDialog;
